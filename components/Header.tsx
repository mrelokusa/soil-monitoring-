...
const Header: React.FC<HeaderProps> = ({ status, lastUpdated, theme, toggleTheme }) => {
        ...
        <header className="bg-brand-surface/80 dark:bg-dark-brand-surface/50 backdrop-blur-sm border-b border-gray-200 dark:border-gray-800 sticky top-0 z-10">
            <div className="container mx-auto px-4 py-4 flex justify-between items-center">
                <div className="flex items-center gap-3">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-brand-primary dark:text-dark-brand-primary" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <h1 className="text-xl font-bold tracking-tight text-brand-text-primary dark:text-dark-brand-text-primary">ARC Smart Agriculture</h1>
                </div>
                <div className="flex items-center gap-4 text-sm">
                   ...
                   <div className="hidden sm:flex items-center gap-2 text-brand-text-secondary dark:text-dark-brand-text-secondary">
